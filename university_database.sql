...
--
-- Host: 127.0.0.1    Database: university_schema
-- ------------------------------------------------------
...
INSERT INTO `courses` VALUES (1,'Lifeskills','Concepts of underwater basket-weaving'),(2,'Economics of Time','A study of non-renewable resources');
...
INSERT INTO `grades` VALUES (1,1,1,1,72),(2,2,2,2,83);
...
CREATE TABLE `professors` (
  ...
  `professor_name` varchar(80) DEFAULT NULL,
...
INSERT INTO `professors` VALUES (1,'Professor Alf','profAlf@email.com'),(2,'Professor Bob','profBob@email.com');
...
INSERT INTO `students` VALUES (1,'John Doe','johndoe@email.com','Computer Science'),(2,'Jane Smith','janesmith@email.com','Mathematics');
...
-- Dump completed on 2023-03-16 15:10:46
